        ...
        <div class="content-main">
            ...
            <div class="left-wing">
                 <div class="wrap">
                      <div class="menu">
                          <ul>
                            <li><a href="#" class="current" data-rel="zappa">Zappa</a></li>
                            <li><a href="explora.php" data-rel="explora">Explora</a></li>
                      ...
                      <div class="tab-content">
                        <h3>The <span>Zappa HD decoder</span> is your gateway to a world of viewing pleasure</h3>
                        <ul>
                          <li>The Zappa HD decoder</li>
                          <li>A world of viewing pleasure</li>
                          <li>Your gateway to a world of viewing pleasure</li>
                        </ul>
                      </div>
